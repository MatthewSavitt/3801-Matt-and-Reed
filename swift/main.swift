...
await expectFailure(meaningfulLineCount(filename: "NoSuchFile.txt"))
await expectSuccess(meaningfulLineCount(filename: "../test-for-line-count.txt"), 5)
...
expect("\(Quaternion.J.conjugate * Quaternion(a: 2, b: 0, c: 0, d: 0))" == "-2.0j")
